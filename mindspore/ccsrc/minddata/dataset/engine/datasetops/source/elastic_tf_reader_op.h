...
class ElasticTFReaderOp : public NonMappableLeafOp {
 public:
  // Constructor of ElasticTFReaderOp (2)
  ...
  ElasticTFReaderOp(int32_t num_workers, int32_t worker_connector_size, int64_t total_num_rows,
  ...
  std::string Name() const override { return "ElasticTFReaderOp"; }
