...
if [ $1 != "resnet50" ] && [ $1 != "resnet101" ]; then
...
env >env.log
if [ $# == 3 ]; then
    python3.7 train.py --net=$1 --dataset=$2 --device_target="GPU" --dataset_path=$PATH1 &>log &
fi

if [ $# == 4 ]; then
    python3.7 train.py --net=$1 --dataset=$2 --device_target="GPU" --dataset_path=$PATH1 --pre_trained=$PATH2 &>log &
fi
cd ..
